function onDropDownChangeGraphHIE() {
    debugger
    ...
    if (BraCode == 1 || BraCode == 6)
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#DropSubject").empty();
                $("#DropDepartment").append("<option value=''>اختر القسم</option>");
                $("#DropRegulation").append("<option value=''>اختر اللائحة</option>");
...
function onDropDownDepartmentGraphChange() {
    debugger
    myVar = document.getElementById('Drop1').value;
    BraCode = document.getElementById('BraCode').value;
    ...
    if (BraCode == 1 && DeptCode != 7) {
        ...
        DeptCode = document.getElementById('DropDepartment').value;
            ...
            var url = p + '//' + h + '/User/Request/Regulation';
        ...
        if (myVar >= 4)
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#DropDepartmentDetail").append("<option value=''>اختر الشعبة</option>");
...
function onDropDownDepartmentAndDetailGraphChange() {
    debugger
    myVar = document.getElementById('Drop1').value;
    BraCode = document.getElementById('BraCode').value;
    DeptCode = document.getElementById('DropDepartment').value;
...
function onDropDownRegulationGraphChange() {
    ...
    if (BraCode == 1) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#DropSubjectDetail").append("<option value=''>اختر المادة الاختيارية</option>");
