function onDropDownChangeIHMIGraph() {
    debugger
    ...
    if ( BraCode == 6)
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#DropDepartmentIhmi").append("<option value=''>اختر القسم</option>");
                var selOpts = "";
...
function onDropDownDepartmentGraphChangeIHMI() {
    debugger
    myVar = document.getElementById('Drop1').value;
    BraCode = document.getElementById('BraCode').value;
...
function onDropDownRegulationGraphChangeIHMI() {
    debugger
    myVar = document.getElementById('Drop1').value;
    BraCode = document.getElementById('BraCode').value;
    DeptCode = document.getElementById('DropDepartmentIhmi').value;
